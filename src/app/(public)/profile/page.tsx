...
// XOÁ DÒNG NÀY: import { Header } from '@/components/layout/public-header'
import { AvatarWithRank } from '@/components/auth/avatar-with-rank'
import { 
  getUserPointsSummary, 
  getPointTransactions,
  getRankHistory 
} from './actions' // Giữ nguyên import actions
...
export default async function ProfilePage() {
  ...
  // Nếu không tìm thấy profile (trường hợp hiếm),
  // có thể redirect hoặc hiển thị lỗi
  if (!profile) {
    // Tùy chọn: redirect('/login') hoặc hiển thị thông báo
    return (
      <div className="container mx-auto px-4 py-8 max-w-6xl text-center">
        <p>Không thể tải thông tin hồ sơ. Vui lòng thử đăng nhập lại.</p>
      </div>
    )
  }

  return (
    // BỎ <div className="min-h-screen bg-background">
    // BỎ <Header ... />
            ...
            <div className="space-y-3">
              {recentTransactions.map((tx) => {
                ...
                const typeColors = {
                  ...
                  admin_adjust: 'text-slate-600 bg-slate-100 dark:bg-slate-900/20',
                  refund: 'text-blue-600 bg-blue-100 dark:bg-blue-900/20',
                }
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {history.from_rank ? (
                        ...
                        <span className="text-sm">Mới tham gia</span>
                      )}
